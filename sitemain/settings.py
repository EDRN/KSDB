...
AUTH_LDAP_BIND_PASSWORD = "r.3>Wwj3FLTnFrHZ"
AUTH_LDAP_USER_SEARCH = LDAPSearch("dc=edrn,dc=jpl,dc=nasa,dc=gov",
    ldap.SCOPE_ONELEVEL, '(uid=%(user)s)')

AUTH_LDAP_GROUP_SEARCH = LDAPSearch("dc=edrn,dc=jpl,dc=nasa,dc=gov",
